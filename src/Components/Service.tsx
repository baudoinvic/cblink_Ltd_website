...
const Service = (props: any) => {
    return (
        ...
        //             </div>
        //         </div>
        //         <span className='block'><FaQuoteLeft className='w-fit' color='#999' size={23} />{props.service.description}<FaQuoteRight className='float-right w-fit' color='#999' size={23} /></span>
        //     </div>
        //   </div>
        // </div>
