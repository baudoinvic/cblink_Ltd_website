  ...
  return (
    <div className='w-full  flex flex-col items-center justify-center'>
      ...
      <div className='w-7/12 flex items-center justify-around'>
        <Link target={'_blank'} to={'/auth/signup'}><button className='w-32 hover:bg-blue-700 h-12 mx-4 cursor-pointer text-lg rounded bg-cblink text-white flex items-center justify-center'>Get It</button></Link>
